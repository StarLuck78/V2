   ...
   <div class="row">
      <div class="col-4 m-auto">
         <form method="POST" action="" enctype="multipart/form-data">
            <label>Mail :</label>
            <input type="text" name="newmail" placeholder="Mail" value="<?php echo $user['adresseMail']; ?>" class="mb-2"/><br />
            ...
            <div class="container text-center">
                  <button type="submit" class="btn btn-outline-secondary m-2">Mettre à jour mon adresse-mail</a></button><br><br>
