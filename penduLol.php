...
<P><FORM ACTION="" METHOD=POST name=Formu>
   <CENTER><FONT SIZE="+1" COLOR="#FFFFFF"><B><A NAME=jeu></A></B></FONT><TABLE BORDER=0 CELLSPACING=0 CELLPADDING=12>
      <TR>
         ...
         <TD>
            ...
            <CENTER><FONT SIZE="+2" COLOR="#000000"><B>Personnages de League of Legends</B></FONT></CENTER>
         </TD>
      </TR>
      <TR>
   ...
   <TABLE BORDER=0 CELLSPACING=0 CELLPADDING=2>
      <TR>
         ...
         <TD WIDTH=150>
            <CENTER>
            <button type="button" class="btn btn-outline-secondary m-2" onclick="depart()">Rejouer</button></CENTER>
         </TD>
   ...
   <HR>
   <button type="button" class="btn btn-outline-secondary m-2" onclick="window.location.href='pendu.php'">Retour</button>
